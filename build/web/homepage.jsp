...
<div class="main-container">
    <div class="news">
        <div class="news-container">
            <img class="news-image" src="img/ca34k.jpg" alt="">

            <a class="news-title" href="">ADJUST ADJUST ADJUSTADJUSTADJUST ADJUSTADJUSTADJUSTADJUSTADJUSTADJUST</a>

            <P class="news-content">AbcdAbcdAbcdAbcdAbcdAbcdAbcdAbcdAbcd
                AbcdAbcdAbcdAbcdAbcdAbcdAbcdAbcdAbcdAbcd
            </P>
            <p style="text-align: right;padding-right:40px;margin-bottom: 0px;"> Author: </p>
            <p style="text-align: right;padding-right:40px;margin-bottom:10pxpx"> Date: </p>

        </div>
    </div>
    <div class="news">
        <div class="news-container">
            <img class="news-image" src="img/ca44k.jpg" alt="">
...
<div class="aboutcontent" id="about-us">
    ...
    <div class="abseccond">
        <div class="flip-card ">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="img/thay.jpg" alt="Avatar" style="width:250px;height:300px;" />
                </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="img/tu.jpg" alt="Avatar" style="width:250px;height:300px;" />
                </div>
                <div class="flip-card-back abicon">
                    <h1>Nguyen Thi Cam Tu</h1>
                    <p>Developer and more</p>
                    <ul>
                        <li class="facebook">
                            <i class="fa fa-facebook fa-2x" aria-hidden="true"></i>
        ...
        <div class="flip-card ">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="img/hoang.jpg" alt="Avatar" style="width:250px;height:300px;" />
                </div>
                <div class="flip-card-back abicon">
                    <h1>Truong Minh Hoang</h1>
                    <p>Developer and more</p>
                    <ul>
                        <li class="facebook">
                            <i class="fa fa-facebook fa-2x" aria-hidden="true"></i>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="img/khang.jpg" alt="Avatar" style="width:250px;height:300px;" />
                </div>
                <div class="flip-card-back abicon">
